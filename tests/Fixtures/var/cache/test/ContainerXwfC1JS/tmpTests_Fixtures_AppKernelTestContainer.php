 ...
 * @final
 */
class tmpTests_Fixtures_AppKernelTestContainer extends Container
{
    ...
    {
        return $this->privates['data_collector.doctrine'] = new \Doctrine\Bundle\DoctrineBundle\DataCollector\DoctrineDataCollector(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1234567890'))), '/_fragment');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        ]), ($this->privates['translator.formatter.default'] ?? $this->getTranslator_Formatter_DefaultService()), 'en', ['translation.loader.php' => [0 => 'php'], 'translation.loader.yml' => [0 => 'yaml', 1 => 'yml'], 'translation.loader.xliff' => [0 => 'xlf', 1 => 'xliff'], 'translation.loader.po' => [0 => 'po'], 'translation.loader.mo' => [0 => 'mo'], 'translation.loader.qt' => [0 => 'ts'], 'translation.loader.csv' => [0 => 'csv'], 'translation.loader.res' => [0 => 'res'], 'translation.loader.dat' => [0 => 'dat'], 'translation.loader.ini' => [0 => 'ini'], 'translation.loader.json' => [0 => 'json']], ['cache_dir' => ($this->targetDir.''.'/translations'), 'debug' => false, 'resource_files' => ['ar' => [0 => (\dirname(__DIR__, 6).'/src/Resources/translations/messages.ar.yml')], 'cn' => [0 => (\dirname(__DIR__, 6).'/src/Resources/translations/messages.cn.yml')], 'de' => [0 => (\dirname(__DIR__, 6).'/src/Resources/translations/messages.de.yml')], 'en' => [0 => (\dirname(__DIR__, 6).'/src/Resources/translations/messages.en.yml')], 'es' => [0 => (\dirname(__DIR__, 6).'/src/Resources/translations/messages.es.yml')], 'fr' => [0 => (\dirname(__DIR__, 6).'/src/Resources/translations/messages.fr.yml')], 'it' => [0 => (\dirname(__DIR__, 6).'/src/Resources/translations/messages.it.yml')], 'pl' => [0 => (\dirname(__DIR__, 6).'/src/Resources/translations/messages.pl.yml')], 'ru' => [0 => (\dirname(__DIR__, 6).'/src/Resources/translations/messages.ru.yml')], 'tr' => [0 => (\dirname(__DIR__, 6).'/src/Resources/translations/messages.tr.yml')], 'ua' => [0 => (\dirname(__DIR__, 6).'/src/Resources/translations/messages.ua.yml')]], 'scanned_directories' => [0 => (\dirname(__DIR__, 6).'/src/Resources/translations'), 1 => (\dirname(__DIR__, 6).'/vendor/symfony/framework-bundle/translations'), 2 => (\dirname(__DIR__, 6).'/tmp/Resources/FrameworkBundle/translations'), 3 => (\dirname(__DIR__, 6).'/vendor/symfony/twig-bundle/translations'), 4 => (\dirname(__DIR__, 6).'/tmp/Resources/TwigBundle/translations'), 5 => (\dirname(__DIR__, 6).'/vendor/doctrine/doctrine-bundle/translations'), 6 => (\dirname(__DIR__, 6).'/tmp/Resources/DoctrineBundle/translations'), 7 => (\dirname(__DIR__, 6).'/tmp/Resources/DataTablesBundle/translations'), 8 => (\dirname(__DIR__, 4).'/AppBundle/translations'), 9 => (\dirname(__DIR__, 6).'/tmp/Resources/AppBundle/translations'), 10 => (\dirname(__DIR__, 4).'/translations'), 11 => (\dirname(__DIR__, 6).'/tmp/Resources/translations')], 'cache_vary' => ['scanned_directories' => [0 => (\dirname(__DIR__, 6).'/src/Resources/translations'), 1 => (\dirname(__DIR__, 6).'/vendor/symfony/framework-bundle/translations'), 2 => (\dirname(__DIR__, 6).'/tmp/Resources/FrameworkBundle/translations'), 3 => (\dirname(__DIR__, 6).'/vendor/symfony/twig-bundle/translations'), 4 => (\dirname(__DIR__, 6).'/tmp/Resources/TwigBundle/translations'), 5 => (\dirname(__DIR__, 6).'/vendor/doctrine/doctrine-bundle/translations'), 6 => (\dirname(__DIR__, 6).'/tmp/Resources/DoctrineBundle/translations'), 7 => (\dirname(__DIR__, 6).'/tmp/Resources/DataTablesBundle/translations'), 8 => 'AppBundle/translations', 9 => (\dirname(__DIR__, 6).'/tmp/Resources/AppBundle/translations'), 10 => 'translations', 11 => (\dirname(__DIR__, 6).'/tmp/Resources/translations')]]]);
    ...
    protected function getTwig_Loader_NativeFilesystemService()
    {
        ...
        $instance->addPath((\dirname(__DIR__, 6).'/vendor/symfony/framework-bundle/Resources/views'), 'Framework');
        $instance->addPath((\dirname(__DIR__, 6).'/vendor/symfony/framework-bundle/Resources/views'), '!Framework');
        $instance->addPath((\dirname(__DIR__, 6).'/vendor/symfony/twig-bundle/Resources/views'), 'Twig');
        $instance->addPath((\dirname(__DIR__, 6).'/vendor/symfony/twig-bundle/Resources/views'), '!Twig');
        $instance->addPath((\dirname(__DIR__, 6).'/vendor/doctrine/doctrine-bundle/Resources/views'), 'Doctrine');
        $instance->addPath((\dirname(__DIR__, 6).'/vendor/doctrine/doctrine-bundle/Resources/views'), '!Doctrine');
        $instance->addPath((\dirname(__DIR__, 6).'/src/Resources/views'), 'DataTables');
        $instance->addPath((\dirname(__DIR__, 6).'/src/Resources/views'), '!DataTables');
        $instance->addPath((\dirname(__DIR__, 4).'/AppBundle/Resources/views'), 'App');
        $instance->addPath((\dirname(__DIR__, 4).'/AppBundle/Resources/views'), '!App');
    ...
    {
        return $this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('1234567890');
    }
    ...
    {
        return [
            'kernel.root_dir' => (\dirname(__DIR__, 6).'/tmp'),
            ...
            'kernel.bundles' => [
                ...
                'AppBundle' => 'Tests\\Fixtures\\AppBundle\\AppBundle',
            ],
            'kernel.bundles_metadata' => [
                ...
                'DataTablesBundle' => [
                    'path' => (\dirname(__DIR__, 6).'/src'),
                    'namespace' => 'Omines\\DataTablesBundle',
                ],
                'AppBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/AppBundle'),
                    'namespace' => 'Tests\\Fixtures\\AppBundle',
                ],
            ],
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'tmpTests_Fixtures_AppKernelTestContainer',
            ...
            'router.resource' => (\dirname(__DIR__, 4).'/routing.yml'),
            'router.cache_class_prefix' => 'tmpTests_Fixtures_AppKernelTestContainer',
